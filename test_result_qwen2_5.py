...
model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
    "/fdata/FragFake/LLaMA-Factory-pre2/output/gemini_easy_qwen2_5_vl_coco", 
    torch_dtype="auto", 
    device_map="auto"
)
processor = AutoProcessor.from_pretrained("/data_sda/models/Qwen2.5-VL-7B-Instruct")
input_path = "/fdata/FragFake/finished_file/dataset/gemini/easy/gemini_easy_test_conversation.json"
output_path = "/fdata/FragFake/finished_file/dataset/gemini/result/gemini_easy_qwen2_5_vl_coco.json"
